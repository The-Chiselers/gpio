...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/Abod2/OneDrive/Desktop/ENEL500/GPIO_vA/test_run_dir/allTests_should_pass/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
struct sim_state {
  ...
  inline void poke(int32_t id, int64_t value) {
    ...
    switch(id) {
      ...
      case 1 : dut->io_apb_PSEL = u; break;
      case 2 : dut->io_apb_PENABLE = u; break;
      case 3 : dut->io_apb_PWRITE = u; break;
      case 4 : dut->io_apb_PADDR = u; break;
      case 5 : dut->io_apb_PWDATA = u; break;
      case 6 : dut->io_pins_gpioInput = u; break;
  ...
  inline int64_t peek(int32_t id) {
    ...
    switch(id) {
      ...
      case 1 : value = dut->io_apb_PSEL; break;
      case 2 : value = dut->io_apb_PENABLE; break;
      case 3 : value = dut->io_apb_PWRITE; break;
      case 4 : value = dut->io_apb_PADDR; break;
      case 5 : value = dut->io_apb_PWDATA; break;
      case 6 : value = dut->io_pins_gpioInput; break;
      case 7 : value = dut->io_apb_PRDATA; break;
      case 8 : value = dut->io_apb_PREADY; break;
      case 9 : value = dut->io_apb_PSLVERR; break;
      case 10 : value = dut->io_pins_gpioOutput; break;
      case 11 : value = dut->io_pins_gpioOutputEnable; break;
      case 12 : value = dut->io_pins_irqOutput; break;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/Abod2/OneDrive/Desktop/ENEL500/GPIO_vA/test_run_dir/allTests_should_pass/GPIO.vcd)";
