...
object virtualPorts extends APBUtils{
  ...
  def virtualMapping(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
  ...
  def virtualToPhysical(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
  ...
  def disableVirtual(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
  ...
  def invalidVirtual(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
  ...
  def disabledVirtualRead(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
  ...
  def overlappingVirtualPorts(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
  ...
  def virtualInput(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
  ...
  def virtualPorts(dut: GPIO, gpioDataBuffer: Seq[UInt], myParams: BaseParams): Unit = {
