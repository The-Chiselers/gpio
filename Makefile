...
verilog: validate
	...
	$(SBT) "run" | tee $(BUILD_ROOT)/synth/verilog.rpt
	grep -r -l "Generated by CIRCT unknown git version" | grep ".sv" | xargs sed -i 's/Generated by CIRCT unknown git version/Generated by CIRCT rev: $(FIRTOOL_REV)/g'
	rm *.anno.json    
